package com.k2j.bargains.gateway.config.resolver;
...
public class UserArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    /**
     * @description: 当请求参数为 UserVo 时，使用这个解析器处理
    ...
    /**
     * @description: 从分布式 session 中获取 UserVo 对象
     * @author: Sakura
     * @date: 4/9/20
     * @param methodParameter:
    ...
    /**
     * @description: 根据cookie名获取相应的cookie值
     * @author: Sakura
     * @date: 4/9/20
     * @param request:
     * @param cookieName:
