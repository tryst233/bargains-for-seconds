...
import com.k2j.bargains.common.api.cache.vo.AccessKeyPrefix;
...
public class AccessInterceptor extends HandlerInterceptorAdapter {
    ...
    /**
     * @description: 渲染返回信息，以 json 格式返回
     * @author: Sakura
     * @date: 4/9/20
     * @param response:
     * @param cm:
    ...
    /**
     * @description: 和 UserArgumentResolver 功能类似，用于解析拦截的请求，获取 UserVo 对象
     * @author: Sakura
     * @date: 4/9/20
     * @param request:
     * @param response:
     * @return: com.k2j.bargains.common.api.user.vo.UserVo UserVo 对象
     **/
    private UserVo getUser(HttpServletRequest request, HttpServletResponse response) {
        ...
        UserVo userVo = redisService.get(BgUserKeyPrefix.TOKEN, token, UserVo.class);
    ...
    /**
     * @description: 从众多的cookie中找出指定cookieName的cookie
     * @author: Sakura
     * @date: 4/9/20
     * @param request:
     * @param cookieName:
     * @return: java.lang.String cookieName对应的value
     **/
    ...
    /**
     * @description: 将cookie存入redis，并将cookie写入到请求的响应中
     * @author: Sakura
     * @date: 4/9/20
     * @param response:
     * @param token:
    ...
    private void addCookie(HttpServletResponse response, String token, UserVo user) {
        ...
        cookie.setMaxAge(BgUserKeyPrefix.TOKEN.expireSeconds());
        cookie.setPath("/");
