...
public class MD5Util {
    ...
    /**
     * @description: 对客户端输入的密码加盐（第一次加盐），得到的MD5值为表单中传输的值
     * <p>
    ...
    /**
     * @description: 对表单中的密码md5加盐，加盐后的md5为存储在数据库中的密码md5
     * @author: Sakura
     * @date: 4/8/20
    ...
    /**
     * @description: 两次MD5：储存在数据库中的密码的md5 = MD5(MD5(input_password) + SALT) + db_salt
     * @author: Sakura
     * @date: 4/8/20
