package com.k2j.bargains.common.exception;
 ...
 * @description: 全局异常处理器（底层使用方法拦截的方式完成，和AOP一样）
...
public class GlobalExceptionHandler {
     ...
     * @param e: 该请求所产生的异常
     * @return: com.k2j.bargains.common.result.Result<java.lang.String> 向客户端返回的结果（这里为json数据）
     **/
    ...
    public Result<String> exceptionHandler(HttpServletRequest request, Exception e) {
        ...
        // 如果所拦截的异常是自定义的全局异常，则按自定义异常的处理方式处理，否则按默认方式处理
