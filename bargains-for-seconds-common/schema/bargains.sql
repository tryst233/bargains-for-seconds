...
#   创建秒杀场景下的表, 包含以下几个表：
#
#   1. 秒杀用户表        bargains_user
#   2. 商品表            goods
#   3. 参与秒杀的商品表   bargains_goods
#   4. 秒杀订单表        bargains_order
#   5. 订单表            order_info
#
# ------------------------------------------------------------------------

CREATE DATABASE bargains;

USE bargains;

# ************************************************************************
# 秒杀用户表
DROP TABLE IF EXISTS `bargains_user`;
CREATE TABLE `bargains_user` (
...
INSERT INTO bargains_user (phone, nickname, password, salt)
...
# ************************************************************************
# 秒杀商品表
DROP TABLE IF EXISTS `bargains_goods`;
CREATE TABLE `bargains_goods` (
  `id`            BIGINT(20) NOT NULL AUTO_INCREMENT  COMMENT '秒杀的商品表',
  `goods_id`      BIGINT(20)          DEFAULT NULL    COMMENT '商品Id',
  `bargains_price` DECIMAL(10, 2)      DEFAULT '0.00'  COMMENT '秒杀价',
...
# 插入两条记录
INSERT INTO `bargains_goods` VALUES
  (1, 1, 0.01, 9, '2020-04-10 00:00:00', '2020-04-30 00:00:00'),
  (2, 2, 0.01, 9, '2020-04-10 00:00:00', '2020-04-30 00:00:00'),
  (3, 3, 0.01, 9, '2020-04-10 00:00:00', '2020-04-30 00:00:00'),
  (4, 4, 0.01, 9, '2020-04-10 00:00:00', '2020-04-30 00:00:00');


# ************************************************************************
# 秒杀订单表
DROP TABLE IF EXISTS `bargains_order`;
CREATE TABLE `bargains_order` (
